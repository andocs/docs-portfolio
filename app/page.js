...
const Home = () => {
  ...
  return (
    <>
      <CustomCursor />
      <main data-scroll-container ref={scrollRef} className="relative">
        <Navbar />
        {/* Home */}
              ...
              <div className="grid grid-cols-8 gap-4">
                ...
                <div className="col-span-4 row-span-1 p-8 items-center bg-white bg-opacity-5 rounded-lg flex gap-5">
                  ...
                  <div className="flex-1 text-justify">
                    ...
                    <br />
                    <p>
                      I'm a 22-year-old <span>Freelance Developer</span> for The
                      Path, with a<span> burning passion for development</span>{" "}
                ...
                <div className="col-span-2 row-span-1 bg-white bg-opacity-5 rounded-lg p-8 text-center flex flex-col justify-center">
                ...
                {/* Row 2 */}
                <div className="col-span-3 row-span-1 bg-white bg-opacity-5 rounded-lg p-8 text-justify flex items-center gap-4">
                  <p className="text-5xl text-center flex">🏅</p>
                  <p>
                    <span>Fun Fact: </span>Won 2 Gold Medals for my Alma Mater,
                    swimming freestyle at the PAPRISA Meet.
                  </p>
                </div>
                <div className="col-span-3 row-span-1 bg-white bg-opacity-5 rounded-lg p-8 text-justify flex items-center gap-4">
                  <p className="text-5xl text-center flex">🎓</p>
                ...
                <div className="col-span-2 row-span-1 bg-white bg-opacity-5 rounded-lg p-8 text-left flex flex-col gap-12 justify-between">
                ...
                {/* Row 3 */}
                <div className="col-span-2 row-span-1 bg-white bg-opacity-5 rounded-lg p-8 text-center flex flex-col gap-5 items-center justify-center">
                ...
                <div className="col-span-4 row-span-1 bg-white bg-opacity-5 rounded-lg p-8 text-center">
                  <Swiper
                    modules={[Autoplay]}
                    spaceBetween={10}
                    slidesPerView={5}
                    ...
                    speed={6500} // Sets the transition speed for smoothness
                    freeMode={true}
                    autoplay={{
                      disableOnInteraction: false,
                      delay: 0,
                ...
                <div className="col-span-2 row-span-1 bg-white bg-opacity-5 rounded-lg p-8 text-left flex items-center justify-center">
                  <a
        ...
        {/* Education */}
        <section data-scroll-section className="flex flex-col py-32">
                ...
                <div className="p-6 bg-white bg-opacity-10 rounded-lg">
                  ...
                  <div className="flex flex-1 flex-col">
                    ...
                    <ul className="pl-4 text-sm flex flex-col gap-2 list-disc text-gray-400">
                      ...
                      <li>
                        <a href="" className="flex items-center gap-1">
                          Cybersecurity Essentials - issued by Cisco | Jan. 2023
                          <RiVerifiedBadgeFill className="text-green-400" />
                        </a>
                      </li>
                      <li>
        ...
        <section className="flex flex-col" id="contact" data-scroll-section>
          <div
            className="container mx-auto px-6 h-full flex flex-col justify-between"
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="flex space-x-4 justify-center">
                <div
                  className="flex items-center p-8 bg-white bg-opacity-5 shadow rounded-lg"
                  data-scroll
                >
